...
class Registries extends Controller {

  private $registriesModel;

  public function __construct() {
    $this->registriesModel = $this->model('Registry');
  }
  ...
  public function create() {
    ...
    if($this->registriesModel->create($data)) {
      echo json_encode(
  ...
  public function update($id) {
    ...
    if($this->registriesModel->update($data, $id)) {
      echo json_encode(
  ...
  public function delete($id) {
    ...
    if($this->registriesModel->delete($id)) {
      echo json_encode(
  ...
  public function read() {
    header('Access-Control-Allow-Origin: *'); //public api
    header('Content-Type: application/json');
    $data = $this->registriesModel->read();
  ...
  public function read_single($id) {
    header('Access-Control-Allow-Origin: *'); //public api
    header('Content-Type: application/json');
    $data = $this->registriesModel->read_single($id);
    //Convert from associative array to JSON before send
    echo json_encode($data); 
  }
 }